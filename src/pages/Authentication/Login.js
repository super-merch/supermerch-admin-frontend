              ...
              <div className="mb-3">
                ...
                {otpCountdown > 0 && (
                  <small className="text-muted">
                    You can resend OTP in {formatTime(otpCountdown)}
                  </small>
                )}
              </div>
              <div className="mb-3">
            ...
            <Form onSubmit={login}>
              ...
              <div className="mb-4">
                ...
                {isSubmit && formErrors.email && (
                  <p style={pageStyles.errorText}>{formErrors.email}</p>
                )}
              </div>
              ...
              <div className="mb-3">
                ...
                {isSubmit && formErrors.password && (
                  <p style={pageStyles.errorText}>{formErrors.password}</p>
                )}
              </div>

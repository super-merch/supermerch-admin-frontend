...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  return (
    ...
    >
      ...
      {/* Navigation Links */}
      <nav className="mt-4 overflow-y-auto space-y-2">
        <Link
          to="/"
        ...
        >
          ...
          <span
            className={`text-white group-hover:text-white transition-all duration-300 ${!isOpen && "hidden"
              }`}
          >
            Dashboard
          </span>
        ...
        <button
          ...
          className="flex items-center px-4 py-2 pb-10 hover:bg-blue-500 group w-full"
        >
        ...
        <motion.div
          ...
          <motion.div
            ...
            <div className="flex gap-2 justify-end mt-2">
              <button className="px-3 py-1 text-white transition duration-300 border rounded hover:bg-gray-100" onClick={() => setShowPopup(false)}>Cancel</button>
              <button onClick={() => {
                handleLogout();
                setShowPopup(false)

...
const AlProducts = () => {
  ...
  const handleSelectAll = () => {
    setSelectedProducts(
      new Set(currentProducts?.map((p) => String(p.meta.id)))
    );
  };
  ...
  const handleDeleteProduct = async () => {
    try {
      ...
      const response = await fetch(
        `${backednUrl}/api/custom-products/delete/${deleteId}`,
        {
          method: "DELETE",
        }
      );
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xl font-bold text-green-600">
                  {prodLength - deactivatedProducts}
                </p>
              </div>
                    ...
                    currentProducts?.map((product, index) => {
                      ...
                      const realPrice =
                        ...
                        priceBreaks[0]?.price !== undefined
                          ? priceBreaks[0].price.toLocaleString("en-US", {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-3 py-3">
                            <div className="flex items-center gap-2 min-w-[200px] hover:cursor-pointer hover:underline">
                              {isEditing ? (
